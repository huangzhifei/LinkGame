...
public class GameServiceImpl implements GameService {
	...
	/* (non-Javadoc)
	 * @see HelpBoard.GameService#start()
	 */
	@Override
	public void start() {
	...
	/* (non-Javadoc)
	 * @see HelpBoard.GameService#getPieces()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see HelpBoard.GameService#hasPieces()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see HelpBoard.GameService#findPiece(float, float)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see HelpBoard.GameService#link(com.hzf.linkgame.HelperViews.Piece, com.hzf.linkgame.HelperViews.Piece)
	 */
	@Override
